...
class Problems:
    def __init__(self):  # 題庫
        ...
        p8 = ["獲得椰林小舖發放的優惠券一張，下一題答對的學分數為2倍",
              "得到管爺青睞，下一題答對的學分數為2倍",
...
class ProblemWindow(tk.Frame):  # 彈出問題的視窗
    ...
    def createWidgets(self):
        self.buttonA = tk.Button(self, height = 4, width = 6, font = "20", text = "A", command = self.click_buttonA)
        self.buttonB = tk.Button(self, height = 4, width = 6, font = "20", text = "B", command = self.click_buttonB)
        self.buttonC = tk.Button(self, height = 4, width = 6, font = "20", text = "C", command = self.click_buttonC)
        self.buttonD = tk.Button(self, height = 4, width = 6, font = "20", text = "D", command = self.click_buttonD)
        self.lbProblem = tk.Label(self, height = 15, width = 55, font = "20", text = self.text)
...
class ShowResult(tk.Frame):  # 切換作答結果頁面
    ...
    def createWidgets(self):
        self.lbResult = tk.Label(self, height = 15, width = 55, font = "40", text = self.text)
        self.buttonSure = tk.Button(self, height = 2, width = 5, font = "20", text = "確認", command = self.click_buttonSure)
        self.buttonSure.grid(row = 1, column = 1, sticky = tk.N)
        self.lbResult.grid(row = 0, column = 0, columnspan = 3, sticky = tk.NE + tk.SW)
...
class ChanceDestinyWindow(tk.Frame):  # 彈出機會命運的視窗
    ...
    def createWidgets(self):
        self.lbChance = tk.Label(self, height = 15, width = 55, font = "20", text = self.text)
        self.buttonSure = tk.Button(self, height = 2, width = 5, font = "20", text = "確認", command = self.click_buttonSure)
        self.buttonSure.grid(row = 1, column = 1, sticky = tk.N)
        self.lbChance.grid(row = 0, column = 0, columnspan = 3, sticky = tk.NE + tk.SW)

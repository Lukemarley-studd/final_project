...
class Game(tk.Frame):
    ...
    def create(self):  # 外圈圖片及內圈格子
        ...
        self.picture01.grid(row=0, column=2, columnspan=1)
        ...
        self.picture02.grid(row=0, column=3, columnspan=1)
        ...
        self.picture03.grid(row=0, column=4, columnspan=1)
        ...
        self.picture04.grid(row=0, column=5, columnspan=1)
        ...
        self.picture05.grid(row=0, column=7, columnspan=1)
        ...
        self.picture06.grid(row=2, column=7, columnspan=1)
        ...
        self.picture07.grid(row=3, column=7, columnspan=1)
        self.picture08= tk.Label(self, height=6, width=20, bg="white")
        self.picture08.grid(row=4, column=7, columnspan=1)
        ...
        self.picture09.grid(row=6, column=7, columnspan=1)
